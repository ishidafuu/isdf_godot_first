...
{
  //コンストラクタ
  TUGLiItemGet::TUGLiItemGet(TUIGenLayer* player) :TUGLiGen(player)
  {
    stLiItemGet_.Init();
  }

  TUGLiItemGet::~TUGLiItemGet()
  {
    //解放時必ず呼ぶ
    ClearRecord();
  }
  ...
  void TUGLiItemGet::DoClearRecord()
  {
    stLiItemGet_.Init();
  ...
  void TUGLiItemGet::DoMakeGroupSub()
  {
    slider_->b_SetModal(TRUE);
  }

  void TUGLiItemGet::Refresh()
  {
    //レコードクリア
    ClearRecord();
  ...
  void TUGLiItemGet::DoUpdateSub(BOOL draw_f)
  {

  }

  void TUGLiItemGet::DoActionSub()
  {

  }

  s64 TUGLiItemGet::GetCommonID()
  {
    return records_[GetActIndex()]->GetCommonID();
  }
  s64 TUGLiItemGet::GetEtcNum()
  {
