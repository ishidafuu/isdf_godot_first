...
namespace db
{
	...
	//----------------------------------------------------------------------------------
	//コンストラクタ
	TUGLiItemSetW::TUGLiItemSetW(TUIGenLayer* player) 
		: TUGLiGenW(player)
	{
		//stLiItemGet_.Init();
	}
	...
	//
	//----------------------------------------------------------------------------------
	LONGVECTOR TUGLiItemSetW::GetData(void)
	{
	...
	//
	//----------------------------------------------------------------------------------
	void TUGLiItemSetW::Refresh(LONGVECTOR2 data)
	{
		enum paramType
		{
			ptType = 0,
	...
	//
	//----------------------------------------------------------------------------------
	void TUGLiItemSetW::DoUpdateSub(BOOL draw_f)
	{
	...
	//
	//----------------------------------------------------------------------------------
	void TUGLiItemSetW::DoActionSub()
	{
	...
	void TUGLiItemSetW::DoClearRecord()
	{
		//stLiItemGet_.Init();
	...
	//
	//----------------------------------------------------------------------------------
	void TUGLiItemSetW::DoMakeGroupSub()
	{
